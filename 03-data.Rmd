...
R has five basic types of data; numeric, integer, logical, complex and character. The keen eyed among you will notice we've only listed four data types here, the final data type is raw which we won't cover as it's not useful 99.99% of the time. We also won't cover complex numbers as we don't have the [imagination][complex_num]!
